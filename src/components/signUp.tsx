import { Button, Checkbox, Container, FormControl, FormControlLabel, InputAdornment, InputLabel, OutlinedInput, Typography } from "@mui/material";
  ...
  return (
    <>
      <Container className="padding-40-24 max-width-500">
        ...
        <div className="margin-top-bottom-24">
          <Button className="primary-button" variant="contained" color="primary">Sign up</Button>
        </div>
      </Container>
    </>
  )
